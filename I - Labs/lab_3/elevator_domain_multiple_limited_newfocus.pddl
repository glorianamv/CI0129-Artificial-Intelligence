...
(reachable ?floor - floor ?elevator - elevator)
;; 
)
...
(:action up
  ...
  :precondition (and (lift-at ?f1 ?e) (above ?f1 ?f2) (reachable ?f2 ?e))
...
(:action down
  :parameters (?f1 - floor ?f2 - floor ?e - elevator)
  :precondition (and (lift-at ?f1 ?e) (above ?f2 ?f1) (reachable ?f2 ?e))
  :effect (and (lift-at ?f2 ?e) (not (lift-at ?f1 ?e))))
)
